...
#define TimeOverflow 0x100000000 // 2^32 - интервал в мс  между двумя очередными сигналами "переполнение СТВ1"
typedef enum {
    timer1,
    timer2,
    timer3,
...
int64_t STV = 0; // снятое в последний раз значение СТВ
...
*/
void MUS_BSP_setSTV(
    int64_t time // устанавливаемое значение СТВ
);
